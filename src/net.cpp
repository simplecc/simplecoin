...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Simplecoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"simplecointools.com", "dnsseed.simplecointools.com"},
    {"simplecoinpool.org", "dnsseed.simplecoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"simplecointools.com", "testnet-seed.simplecointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Simplecoin is probably already running."), addrBind.ToString().c_str());
        else
